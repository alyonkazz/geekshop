...
MIDDLEWARE = [
    # 'django.middleware.cache.UpdateCacheMiddleware',  # always first for cache all site
    ...
    # 'django.middleware.cache.FetchFromCacheMiddleware',  # always last for cache all site
]
